...
class QSystemNeuralInfo(QWidget):
    ...
    def __init_UI(self):
        ...
        self.__layout.addWidget(self.__accuracy_label)
    ...
    def update_system_info(self):
        ...
        self.__accuracy_label.setText(f"<b>MSE</b>: {system.model_wrapper.mse}")